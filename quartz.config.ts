...
const config: QuartzConfig = {
  configuration: {
    pageTitle: "🪴 Steven's Digital Garden",
    pageTitleSuffix: "",
    enableSPA: true,
    enablePopovers: true,
    analytics: {
      provider: "umami",
      host: "https://umami.stevensmith.me",
      websiteId: "14eadd39-2eea-4183-9b5b-b2bf5eba5cc1",
    },
    locale: "en-US",
    ...
    generateSocialImages: {
      ...
      height: 400, // height to generate with (in pixels)
